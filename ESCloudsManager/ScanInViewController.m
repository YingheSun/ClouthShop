...
#import "ScanInModel.h"
#import "ScanInCellTableViewCell.h"
#import <AVFoundation/AVFoundation.h>
#import <AssetsLibrary/AssetsLibrary.h>
#import "AudioToolbox/AudioToolbox.h"

@interface ScanInViewController ()<AVCaptureMetadataOutputObjectsDelegate,UITableViewDataSource,UITableViewDelegate>{
    NSTimer *_timer;
    BOOL  _flag;
    BOOL  _isOn;
...
@implementation ScanInViewController
...
-(void)requestForScanIn:(NSString *)barcode{
    ...
    [XSHttpTool GET:@"StockInStack.AddToStack" param:dic success:^(id responseObject) {
        ...
        if ([jsonDic[@"ret"] intValue] == 200) {
            ...
            [_listArray addObjectsFromArray:[ScanInModel objectArrayWithKeyValuesArray:jsonDic[@"data"]]];
            if (!_detailTable) {
...
-(void)createDetailTable{
    ...
    [_detailTable registerClass:[ScanInCellTableViewCell class] forCellReuseIdentifier:@"cellID"];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    ScanInCellTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:cellID];
    cell.backgroundColor = [UIColor clearColor];
    ScanInModel *model = _listArray[indexPath.row];
